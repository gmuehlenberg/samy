...
class UserUpdate extends Update<UserMessage, UserModel> {
  ...
  Option<UserModel> processMessage(UserMessage message, UserModel model) {
    if (message is CreateUser) {
      return Some(model.copyWith(surname: 'Neuer', lastname: 'Olive Tree', street: "Karl-Liebknecht-Straße 38", city: 'Leipzig', postCode: '04107', mail: 'döner@olivetree.de', password: 'dönermachtschöner123'));
    }
